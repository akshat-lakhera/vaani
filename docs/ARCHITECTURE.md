...
- Index all 55 GB. That is a download, not a system.
- Hide STT/LLM inside the 200ms claim.
- Submit a single lucky latency run.
- Invent ablation numbers. If two strategies tie, we say they tied.
